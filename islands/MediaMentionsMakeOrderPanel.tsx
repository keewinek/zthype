...
export function MediaMentionsMakeOrderPanel()
{
    ...
    const sources = [
        ...
        { source_id: "quila_personalized_article", title: "Quila - Wyreadagujemy artykuł specjalnie dla was." },
        { source_id: "quila_compilation", title: "Quila - Wspomnimy o was przy okazji tworzenia listy projektów ze zwolnionych." },
